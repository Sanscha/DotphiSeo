...
class HomeScreenn extends StatefulWidget {
  ...
  HomeScreenn({required this.user, required this.selectedProjectCode,
  ...
  Future<void> fetchLeadCounts({String? projectId, String? projectCode}) async {
    ...
    try {
      ...
      final leadCounts = await Future.wait([
        ...
        _fetchLeadCountsFromApi(
            projectId,
            tillDateApi: 'https://clients.dotphi.com/Api/login/getCountofliveLeads',
            todayApi: 'https://clients.dotphi.com/Api/login/getTodayliveLeads',
            weeklyApi: 'https://clients.dotphi.com/Api/login/getWeeklyliveLeads',
            monthlyApi: 'https://clients.dotphi.com/Api/login/getMonthlyLiveLeads'
        ),
      ]);
      ...
      setState(() {
        _tillDateLeadCount = (regularCounts['tillDate']! + liveCounts['tillDate']!);
          ...
          SafeArea(
            child: Scaffold(
              ...
              appBar: AppBar(
                  ...
                  toolbarHeight: 80, toolbarOpacity: 0.7,
            ...
            child: Column(
              ...
              children: [
                Text(
                  title,
                  style: TextStyle(
                    fontSize: 22, fontWeight: FontWeight.bold, color: Colors.teal.shade300,
                  ),
                ),
                SizedBox(height: 6),
                Text(description,
...
class DashboardCard extends StatelessWidget {
  ...
  DashboardCard({required this.title, required this.count, required this.color});
